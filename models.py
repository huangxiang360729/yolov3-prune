...
class Darknet(nn.Module):
    ...
    def __init__(self, cfg, img_size=(416, 416), verbose=False):
        ...
        if isinstance(cfg, str):
            ...
            hyperparams = self.module_defs[0]
            cfg_path = hyperparams["cfg_path"]

        self.module_list, self.routs, self.hyperparams= create_modules(self.module_defs, img_size, cfg_path)
        #+++++++++++++++++++++++++ insert +++++++++++++++++++++++++#
